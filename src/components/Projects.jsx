...
import msimg from "../assets/ms_home.png";
export default function Projects() {
  return (
    <div className="ProjectsContainer h-auto w-full pr-2">
      <h1 className=" text-lg  font-semibold pt-28 lg:pt-20 lg:pb-1 pb-8 opacity-80 lg:opacity-95 lg:text-lg">
        PROJECTS
      </h1>

      <div className="project1-1  w-full h-auto  flex flex-col-reverse lg:flex-row rounded-md lg:px-3 lg:py-10 ">
        <div className="w-4/5 lg:w-1/3 h-auto">
          <img src={msimg} alt="img" className="py-5 lg:py-0 lg:h-auto pr-4" />
        </div>
        <div className="w-full lg:w-2/3 h-auto flex flex-col gap-3">
          <h1
            ...
            onClick={() =>
              window.open("https://github.com/AnilReddyDev/MeetingSpace", "_blank")
            }
          >
            MeetingSpace{" "}
            <svg
